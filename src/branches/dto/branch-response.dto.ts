...
export class BranchResponseDto {
  ...
  @ApiProperty({ nullable: true, description: 'Dia del mes del corte (1..31).' })
  cutoffDay: number | null;

  @ApiProperty({ nullable: true, description: 'Dia del mes limite de pago (1..31).' })
  paymentDay: number | null;

  @ApiProperty({ nullable: true, description: 'Dias de ventana de pago anticipado.' })
